<?php
    $myPage = 'Les constantes';
    require 'partial/head.php';
?>
    <h1>Les constantes</h1>

<?php
    echo '<p>Une constante permet de conserver une valeur sauf que celle-ci ne peut pas être modifiée durant
            l\'exécution du ou des scripts. Utile pour par exemple conserver les paramètres de connexion à la BDD sans pouvoir les modifier une fois définis.</p>';
...
?>
    ...
    <h2>Constantes magique</h2>
<?php
    echo 'Il y a neuf constantes magiques qui changent suivant l\'emplacement où elles sont utilisées.';
